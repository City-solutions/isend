      ...
      <div className="container mx-auto text-center relative z-10">
        ...
        <div className="steps grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            ...
            <h3 className="text-xl font-semibold mb-2 text-gray-700">1. Request a Pickup</h3>
            <p className="text-gray-600">Describe your package, and we'll handle the rest.</p>
          </div>
          {/* Step 2 */}
          <div
            className="step p-6 bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 h-72 flex flex-col items-center justify-center transform hover:scale-105"
          ...
          >
            ...
            <h3 className="text-xl font-semibold mb-2 text-gray-700">2. Track in Real-Time</h3>
            <p className="text-gray-600">Follow your package with our live tracking feature.</p>
          </div>
          {/* Step 3 */}
          <div
            className="step p-6 bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 h-72 flex flex-col items-center justify-center transform hover:scale-105"
          ...
          >
            ...
            <h3 className="text-xl font-semibold mb-2 text-gray-700">3. Safe & On-Time Delivery</h3>
            <p className="text-gray-600">Your package arrives safely at its destination.</p>
          </div>
        </div>
      </div>
    </section>
