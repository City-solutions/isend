      ...
      <div className="container mx-auto text-center relative z-10">
        ...
        <div className="pricing-options grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div
            ...
            data-aos="zoom-in"
            data-aos-delay="100" // Add delay for staggered animations
          >
            <FontAwesomeIcon icon={faDollarSign} className="text-green-500 text-5xl mb-4" />
            <h3 className="text-xl font-semibold mb-2 text-gray-700">Per Delivery</h3>
            <p className="text-gray-600">Pay per delivery based on distance.</p>
            <a href="#request-form" className="cta-button bg-blue-500 text-white font-semibold py-2 px-4 rounded-full hover:bg-blue-600 transition duration-200 mt-4 inline-block">
              Choose Plan
            </a>
          </div>
          ...
          <div
            className="price-option p-6 bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 transform hover:scale-105"
            data-aos="zoom-in"
            data-aos-delay="200" // Staggered animations
          >
            <FontAwesomeIcon icon={faClipboardCheck} className="text-orange-500 text-5xl mb-4" />
            <h3 className="text-xl font-semibold mb-2 text-gray-700">Monthly Subscription</h3>
            <p className="text-gray-600">Unlimited deliveries for a fixed monthly price.</p>
            <a href="#request-form" className="cta-button bg-blue-500 text-white font-semibold py-2 px-4 rounded-full hover:bg-blue-600 transition duration-200 mt-4 inline-block">
              Choose Plan
            </a>
          </div>
          ...
          <div
            className="price-option p-6 bg-white rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 transform hover:scale-105"
            data-aos="zoom-in"
            data-aos-delay="300" // Staggered animations
          >
            <FontAwesomeIcon icon={faTruck} className="text-blue-500 text-5xl mb-4" />
            <h3 className="text-xl font-semibold mb-2 text-gray-700">Premium Package</h3>
            <p className="text-gray-600">Priority deliveries and additional features.</p>
            <a href="#request-form" className="cta-button bg-blue-500 text-white font-semibold py-2 px-4 rounded-full hover:bg-blue-600 transition duration-200 mt-4 inline-block">
              Choose Plan
            </a>
          </div>
